            ...
            <div id="templatemo_content">
                ...
                <div class="templatemo_content_section_01">
                    <div class="section_01_left">
                        <form action ="owneraction.jsp" method="post" onsubmit="return Checked();" style="margin-left: 150px;float: left">
                        ...
                        <img src="images/owner.png" width="400px" height="200px;" style="float: right;background: transparent"></img>
                    </div> 
