            ...
            <div id="templatemo_content">
                ...
                <div class="templatemo_content_section_01">
                    <div class="section_01_left">
                        <form action ="uaction.jsp" method="post" onsubmit="return Checked();"style="margin-left: 150px;float: left">
                        ...
                        <h2 style="margin-left: 600px">User Login</h2>
                        <img src="images/user.png" width="400px" height="200px;" style="float: right;background: transparent"></img>
                    </div> 
